...
<div class="position-relative iq-banner">
  ...
  <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
    <div class="container-fluid navbar-inner">
      ...
      <a class="btn btn-outline-dark d-lg-none d-block" href="/logout"><i class='bx bx-power-off'></i>
      </a>
          ...
          <li class="nav-item dropdown">
            <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              <div class="caption ms-3 d-none d-md-block ">
                ...
                <em class="mb-0 caption-sub-title italic">{{ auth()->user()->role->name }}</em>
                
              </div>
            </a>
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
              <li>
                 <a type="button" class="dropdown-item" href="/logout">Logout</a> 
              </li>
            </ul>
          </li>
        </ul>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="flex-wrap d-flex justify-content-between align-items-center">
            <div>
              <!--<h1 data-bind="text : materialnavtop.Recordmaterialnavtop.NAME">Hello Devs!</h1>-->
              <!--<h1>Hello {{Session::get('namestaf')}}!</h1>-->
              <p>Hi {{ auth()->user()->name }}, Sekarang anda berada di Content Management System.</p>
            </div>
            <div>
